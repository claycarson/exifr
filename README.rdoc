This fork adds the ability to references lens_make and lens_model. It also adds the ability to get exif from a URL in addition to a file referenced [here](https://github.com/remvee/exifr/pull/30).
